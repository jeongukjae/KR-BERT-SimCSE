...
import tfds_korean.klue_sts  # noqa
...
def main(argv):
    ...
    dataset = tfds.load("klue_sts", split="dev").batch(FLAGS.batch_size)
    ...
    print("PearsonR", stats.pearsonr(label_score, pred_score)[0])
